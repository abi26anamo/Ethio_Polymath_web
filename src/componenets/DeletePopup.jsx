...
const DeletePopup = ({ onClose, deleteHandler, deleteContent, title }) => {
  ...
  return (
    ...
    >
      <div
        className={`bg-[#FAFAFA] shadow-[0_0px_50px_0px_rgba(0,0,0,0.3)] rounded-2xl md:min-w-[450px] lg:min-w-[500px] xl:min-w-[550px] 2xl:min-w-[600px] 3xl:min-w-[650px] flex flex-col items-center  gap-12 px-14 py-20 z-50`}
      >
